export default function Footer() {
  return (
    <footer className="bg-white px-6 md:px-16 lg:px-24 xl:px-32 w-full">
      <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-200">
        <div className="max-w-96">
            <h1 className="text-indigo-600 font-semibold text-lg">StartupX</h1>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-gray-500">
        ...
        <a href="https://prebuiltui.com" className="hover:text-gray-700">
          StartupX
        </a>
        . All Right Reserved.
      </p>
